...
const buttons = btnDiv.childNodes;
...
const playRound = () => {
  ...
  buttons.forEach((button) => {
    // console.log(value.innerText /*, key, parent*/);
    button.addEventListener("click", (e) => {
      const computerChoice = getComputerChoice();

      if (computerChoice === "scissors") {
        resultPara = `<p>You chose: ${e.target.textContent.toLowerCase()}<br>Computer chose:
        ${computerChoice}<br>You win round! ${e.target.textContent.toLowerCase()} beats ${computerChoice}</p>`;
        playerScore++;
        result = `<p>Your score: ${playerScore}<br>Computer score: ${computerScore}</p>`;
      } else if (computerChoice === "paper") {
        resultPara = `<p>You chose: ${e.target.textContent.toLowerCase()}<br>Computer chose:
        ${computerChoice}<br>You lose round! ${computerChoice} beats ${e.target.textContent.toLowerCase()}</p>`;
        computerScore++;
        result = `<p>Your score: ${playerScore}<br>Computer score: ${computerScore}</p>`;
      } else {
        resultPara = `<p>You chose: ${e.target.textContent.toLowerCase()}<br>Computer chose:
